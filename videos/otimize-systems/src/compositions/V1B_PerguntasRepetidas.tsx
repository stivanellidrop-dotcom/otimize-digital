...
// =========================================================
// CENA 1 — 0-3s — Hook: contador 0->50x
// =========================================================
const SceneHook: React.FC = () => {
  ...
  const counterScale = interpolate(counterSpring, [0, 1], [0.5, 1]);
  ...
  return (
    ...
    >
      ...
      <Caption text="A mesma pergunta..." fontSize={isVertical ? 88 : 64} />
      ...
      <div
        style={{
          ...
          textShadow: `0 0 60px rgba(239,68,68,0.5), 0 0 120px rgba(239,68,68,0.25)`,
          display: "flex",
          alignItems: "baseline",
          gap: isVertical ? 12 : 8,
        }}
      >
        <span>{num}</span>
        <span style={{ fontSize: isVertical ? 160 : 110, color: THEME.text }}>
          x
        </span>
      </div>
...
// =========================================================
// CENA 2 — 3-10s — Sem IA: bolhas iguais empilhando
// =========================================================
const SceneSemIA: React.FC = () => {
  ...
  const messages: WhatsAppMessage[] = [
    { from: 6, side: "in", text: "Tem M? (Ana)" },
    { from: 30, side: "in", text: "Tem M? (Bia)" },
    { from: 56, side: "in", text: "Tem M? (Carla)" },
    { from: 84, side: "in", text: "Tem M? (Duda)" },
    { from: 112, side: "in", text: "Tem M? (Eli)" },
    { from: 145, side: "out", text: "Tem sim (resp manual)" },
  ];
  ...
  const sweatSpring = spring({
    frame: frame - 140,
    fps,
    config: { damping: 14, stiffness: 160 },
  });
  const sweatOpacity = interpolate(sweatSpring, [0, 1], [0, 1], {
    extrapolateRight: "clamp",
  });
  const sweatScale = interpolate(sweatSpring, [0, 1], [0.4, 1]);
  ...
  return (
    ...
    >
      ...
      >
        Sem IA: voce responde 50x por dia
      </div>
      <div
        style={{
          display: "flex",
      ...
      >
        <WhatsAppMockup
          contactName="Varios clientes"
          contactStatus="enviando agora..."
          avatarLetter="?"
        ...
        <div
          style={{
            ...
            alignItems: "center",
            gap: 12,
            transform: `scale(${sweatScale})`,
            opacity: sweatOpacity,
          }}
        >
          <div style={{ fontSize: isVertical ? 84 : 56, lineHeight: 1 }}>😅</div>
          <div style={{ fontSize: isVertical ? 60 : 40, lineHeight: 1 }}>💦</div>
          <div style={{ fontSize: isVertical ? 60 : 40, lineHeight: 1 }}>😵</div>
        </div>
      </div>
    </AbsoluteFill>
  ...
  return (
    <AbsoluteFill>
      ...
      >
        ...
        >
          E se um <span style={{ color: THEME.verde }}>robo</span>
          <br />
          respondesse o trivial?
        </div>
      </AbsoluteFill>
    </AbsoluteFill>
  );
...
const SceneComOtimize: React.FC = () => {
  ...
  const messages: WhatsAppMessage[] = [
    { from: 6, side: "in", text: "Tem M? (Ana)" },
    { from: 9, side: "in", text: "Tem M? (Bia)" },
    { from: 12, side: "in", text: "Tem M? (Carla)" },
    {
      from: 30,
      side: "out",
      imageUrl: `url(${staticFile("products/vestido-floral.jpg")})`,
    },
    { from: 40, side: "out", text: "Ana: temos M, P, G — R$89,90 Pix" },
    { from: 55, side: "out", text: "Bia: temos M, P, G — R$89,90 Pix" },
    { from: 70, side: "out", text: "Carla: temos M, P, G — R$89,90 Pix" },
    { from: 110, side: "in", text: "Ana: quero!" },
    { from: 125, side: "in", text: "Bia: vou levar 2!" },
  ];
    ...
    >
      ...
      >
        <WhatsAppMockup
          ...
          contactStatus="respondendo todos em paralelo"
          avatarLetter="O"
      ...
      >
        ...
        >
          em <span style={{ color: THEME.verde }}>paralelo</span>.
        </div>
      </div>
    </AbsoluteFill>
  );
...
const SceneResumo: React.FC = () => {
  ...
  const features = [
    ...
    "Voce so atende lead quente",
    "3h do seu dia liberadas",
  ];
  ...
  return (
    ...
    >
      ...
      >
        Trabalho repetitivo,{" "}
        <span style={{ color: THEME.verde }}>delegado</span>
      </div>
      <div
        style={{
          display: "flex",
...
// =========================================================
// COMPOSICAO RAIZ — V1B_PerguntasRepetidas (30s @ 30fps = 900 frames)
// =========================================================
export const V1B_PerguntasRepetidas: React.FC = () => {
  return (
